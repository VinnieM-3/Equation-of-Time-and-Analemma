...
fig = plt.figure(constrained_layout=True, num='Equation of Time')
...
ax_eot.grid(which='minor', linestyle='-', linewidth=0.25, color='grey')
...
ax_analemma.grid(which='minor', linestyle='-', linewidth=0.25, color='grey')
...
slide_obl_deg = Slider(ax_slider_obl, 'Obliquity', 0.0, 45.0, valinit=axis_norm_degs, valstep=0.1, valfmt='%4.2f',
                       facecolor='green', dragging=False)
